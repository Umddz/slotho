    ...
    return (
        <div className="nav">
            ...
            <button
                ...
                onClick={() => open('https://discord.com/oauth2/authorize?client_id=1147583172821909556&redirect_uri=https%3A%2F%2Fslotho.vercel.app%2F&response_type=token&scope=identify')}
            >
